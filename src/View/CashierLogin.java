...
public class CashierLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pfPassword.setCaretColor(new java.awt.Color(0, 0, 0));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
         cashier.setUsername(tfUsername.getText());
            cashier.setPassword(Integer.valueOf(pfPassword.getText()));
            CashierService cservice = new CashierService();
            Cashier c = null;
        try {
            c = cservice.verify(cashier.getUsername(),cashier.getPassword());
            if(c == null){
    ...
    public void setKola(Integer kola) {
        this.kola = kola;
    }
